...
public class Producer extends BaseProducer {
    ...
    // java -javaagent:path/to/opentelemetry-javaagent.jar -Dotel.service.name=my-kafka-service -Dotel.traces.exporter=jaeger -Dotel.metrics.exporter=none -jar target/kafka-producer-agent-1.0-SNAPSHOT-jar-with-dependencies.jar
